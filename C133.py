...
fig = px.bar(x=hd_10180_planet_names, y=hd_10180_planet_masses, title="C131")
...
fig = px.scatter(x=planet_radiuses, y=planet_masses, size=planet_gravity, hover_data=[planet_names], title="C131")
...
fig = px.scatter(x=planet_radiuses, y=planet_masses, title="C132")
fig.update_layout(xaxis_title="Planet Radius", yaxis_title="Planet Masses")
fig.show()
...
fig = px.scatter(x=planet_radiuses, y=planet_masses, color=planet_types, title="C132")
...
fig = px.scatter(x=orbital_radiuses, y=orbital_periods, title="C133")
